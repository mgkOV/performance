...
!(function (t) {
  ...
  function (t, e, i) {
    ...
    try {
      ...
      !(function (t, e, i) {
        ...
        Ya.Context._init(),
        (0, r.setContextStaticExecutionTime)(a, s);
    } catch (t) {
  ...
  function (t, e, i) {
      ...
      c =
        ...
        !!p &&
          ...
          !!n.classList.contains("c2") &&
            (n.classList.toggle("c3", !1), !n.classList.contains("c3")))),
      d = (function () {
    ...
    function h(t, e) {
      for (var i = u(e), n = 0; n < i.length; n++) if (!t.classList.contains(i[n])) return !1;
      return !0;
    }
    function g(t, e) {
    ...
    function _(t, e) {
      void 0 === e && (e = ""),
        0 !== t.className.length
          ? t.classList
            ? y(t, e)
            : (function (t, e) {
                var i = m(t).split(" ").concat(e.split(" "));
                (i = a.unique(
                  o.filter(i, function (t) {
                    return "" !== t;
                  })
                )),
                  f(t, i.join(" "));
    ...
    var y = c
      ...
      : function (t, e) {
          for (var i = u(e), n = 0; n < i.length; n++) t.classList.add(i[n]);
        };
    ...
    var b = c
      ...
      : function (t, e) {
          for (var i = u(e), n = 0; n < i.length; n++) t.classList.remove(i[n]);
        };
    ...
    !(function (o) {
      var r =
        ...
        p =
          ...
          function (t) {
            var e = [];
            for (var i in t) s.call(t, i) && e.push(i);
            return e;
          },
        c = function (t, e) {
      ...
      for (var _ in g) g.hasOwnProperty(_) && (h = !1);
      ...
      function b(t, e, i) {
        for (
          var n,
            ...
            a = (function (t) {
              var e = p(t);
              if (h) for (var i, n = 0; (i = y[n++]); ) t.hasOwnProperty(i) && e.push(i);
              return e;
            })(i),
            s = 0,
            l = a.length;
          ...
          "__self" !== (n = a[s++]) &&
            ((o = i[n]),
            !m(o) ||
            (o.prototype && o.prototype.__self) ||
            (r && !(o.toString().indexOf(".__base") > -1))
              ? (e[n] = o)
              : (e[n] = (function (i, n) {
      ...
      function x() {
        var t = arguments,
          ...
          r = t[i ? 2 : 1],
          s =
            o.__constructor || (i && n.prototype && n.prototype.__constructor)
              ? function () {
      ...
      (t.exports = x),
        "object" == typeof modules &&
          "function" == typeof modules.define &&
  ...
  function (t, e, i) {
    ...
    var n = i(197),
      ...
      r = i(10);
    function a(t, e) {
      if (r.isArray(t)) for (var i = 0, n = t.length; i < n; i++) a(t[i], e);
      else e.push(t);
    }
    t.exports = function (t, e) {
      return (
        "string" == typeof t && (e || (e = {}), (e.tag = t), (t = n.element)),
        new t(
          e,
          (function (t, e) {
  ...
  function (t, e, i) {
    ...
    (O.prototype = {
      render: function (t, e) {
        (0, s.saveBundleType)(t.bundle),
          (0, s.saveBundleType)(t.data),
          (t.uniqueId = (0, m.generateHexString)(10)),
          (0, f.logRenderLabel)(t.uniqueId, f.BlockRenderSteps.AdvManagerInit);
      ...
      _shouldReloadAds: function () {
        return (
          !(0, s.checkBundleType)(s.bundleTypes.SSP) &&
          !(0, s.checkBundleType)(s.bundleTypes.mobileSdk)
        );
      },
        ...
        if (o) {
          ...
          if (((i = g.isolate(i)), (e = g.isolate(e)), this._bidPending || this._bidRenderParams))
            ...
            var a = this._getBidCallback(e, i),
              p = g.protect(
                "advmanager.getBid: reload error",
                function () {
                  this._resetBid(),
                    i(
                      new Error(
      ...
      _loadSecondBundle: function () {
        var t = this;
        this._isSecondBundleLoading ||
          ((this._isSecondBundleLoading = !0),
          k(
            function () {
      ...
      _getBidCallback: function (t, e) {
        return g.protect(
          "advmanager.bidCallback",
          function (i) {
            if (((this._bidPending = !1), (this._bidRenderParams = i), i.dataFromParams))
              return (
                this._resetBid(), void e(new Error("Cannot use data from parameters with getBid"))
              );
      ...
      _sendExternalResourceError: function (t) {
        u.logger.error(
          new Error(t.srcElement.tagName + ": " + t.target.src),
      ...
      _wrapOnRenderInStorage: function (t, e) {
        this._settingsStorage[S.getRenderId(t)].args[0].onRender = function () {
          ...
          t[0] && ((t[0].confirmVisibility = function () {}), (t[0].refresh = !0)),
            e.apply(null, t);
        };
      },
      ...
      _renderInternal: function (t, e) {
        ...
        v === C
          ? this._renderRealInternal(v, n, e)
          : v(
              function (t) {
      ...
      _renderInpage: function (t, e) {
        ...
        (0, s.saveBundleType)(n.bundle),
          x === C
            ? this._renderRealInPage(x, n, e)
            : x(
                function (t) {
      ...
      _renderFullscreen: function (t, e) {
        ...
        w === C
          ? this._renderRealFullscreen(w, n, t, e)
          : w(
              function (o) {
      ...
      _logUnknown: function (t) {
        u.logger.warn(
          new Error("Unknown block type. blockId: " + t),
      ...
      _renderOldDirect: function (t, e, i, n, o) {
        if (h.dom.querySelector("#" + e)) {
          ...
          if (
            ((r.uniqueId = (0, m.generateHexString)(10)),
            (0, f.logRenderLabel)(r.uniqueId, f.BlockRenderSteps.AdvManagerInit),
            (r.forcedSyncMode = o),
            i.type === _.Products.STRIPE ||
              i.ad_format === _.Products.DIRECT ||
      ...
      renderDirect: function (t, e, i, n) {
        ...
        (0, r.isRtbInOldDirectExperiment)(t, Boolean(i.search_text)) && !i.data
          ? this.render(
              h.extend(h.camelizeKeys(i), {
      ...
      _prepareArgs: function (t, e) {
        var i = t[e];
        return (
          this._shouldReloadAds() && (0, c.isObject)(i) && i.isDataRefreshed && delete i.data, t
        );
      },
      ...
      _initAdRefreshment: function () {
        ...
        (0, l.on)(document, p.changeEventName, function () {
          p.isHidden()
            ? ((e = Date.now()), t._refreshTime && clearTimeout(t._refreshId))
            : (Date.now() - e > t._hiddenTime && t._renderAgain(), t._autoRerender());
        }),
          this._autoRerender();
      },
      _autoRerender: function () {
        this._refreshTime &&
          (this._refreshId = g.setProtectedTimeout(
            function () {
            ...
            if (r && !t.hasCookie() && !this.container && (p.isIOS || p.isAndroid)) {
              ...
              (s.renderTo = this.container.getBody().id),
                ...
                (s.onRender = function (t) {
                  ...
                  return (
                    t.product === c.Products.DIRECT && o.container.setWidthModifier("_width_full"),
  ...
  function (t, e, i) {
    ...
    var n =
      ...
      l = function (t, e, i, o) {
        ...
        if (s.test(i)) {
          for (var a = i.split(s), l = 0, p = a.length; l < p; l++) t[e].apply(t, [a[l]].concat(o));
          return !1;
        }
        return !0;
      },
      p = function (t, e) {
        ...
        switch (e.length) {
          ...
          case 1:
            ...
            return;
          case 2:
            for (; ++n < o; ) (i = t[n]).callback.call(i.ctx, r, a);
            return;
          case 3:
            for (; ++n < o; ) (i = t[n]).callback.call(i.ctx, r, a, s);
            return;
          default:
        ...
        r[e] = function (e, i, r) {
          return (
            ((this._listeners || (this._listeners = {}))[
              e._listenerId || (e._listenerId = o.genRnd("l"))
            ] = e),
          ...
          (e.prototype.renderButton = function () {
            return this.props.isLabel
              ? r.create(
                  ...
                  s["default"]("HIDE", this.props.language)
                )
              : r.create(
                  "yatag",
                  {
    ...
    t.exports = function (t) {
      ...
      return (
        e.push(
          ...
          t.id,
          " .b7f1cd873{height:100px !important}.",
          t.id,
          " .u35edefb5{height:50px !important}.",
          t.id,
          " .vacac0f3e{top:0 !important}.",
          t.id,
          " .vacac0f3e .j39bc76f6{top:3px !important}.",
          t.id,
          " .fea5e471a{bottom:0 !important}.",
          t.id,
    ...
    (O.prototype = {
      render: function (t, e, i) {
        ...
        var n = w.protect(
            "Rtb.render",
            function (e) {
              (0, g.logRenderLabel)(t.uniqueId, g.BlockRenderSteps.RtbDataParsed),
                this.renderByData(e, {});
            },
            this
          ),
      ...
      _getManager: function (t) {
        ...
        return (
          "D" === e.product && (0, l.isFakeImpId)(e.impId) && (i += "#" + t.renderTo),
          i in this._managers ||
            (this._managers[i] = new k({
      ...
      _load: function (t, e, i, n) {
        ...
        if (Ya.Context._asyncModeOn) this._loadData(o, t, e, !1, i, n);
        else {
      ...
      _loadData: function (t, e, i, d, u, v) {
        ...
        if (e.data)
          return (
            (0, g.stopLoggingTime)(e.uniqueId),
            (0, b.saveBundleType)(e.data),
            void u({
              cfg: e,
              data: e.data,
              rtbManager: t,
        ...
        var O = function (a, d) {
          ...
          var v = (0, s.getAdUsageStorage)(e),
            ...
            A = void 0;
          A =
            "D" === S.parseBlockId(e.blockId).product
            ...
            C.loadRtb(
              {
                ...
                additionalBanners:
                  p.additionalBanners ||
                  e.additionalBanners ||
                  (e.oldDirectSettings && e.oldDirectSettings.additional_banners) ||
                  "",
              ...
              function (o) {
                (0, g.logRenderLabel)(e.uniqueId, g.BlockRenderSteps.RtbLoadDone),
                  h.logger.log({
                ...
                o.rtb || !e.oldDirectSettings || r
                  ? ((0, b.saveBundleType)(o),
                    u({
                      cfg: e,
                      data: o,
                      rtbManager: t,
                  ...
                  : (0, _.isFunction)(e.oldDirectCallback) &&
                    ((0, g.stopLoggingTime)(e.uniqueId),
                    h.logger.info({
      ...
      getBlocksToRerender: function () {
        var t = [];
        return (
          x.forOwn(this._managers, function (e) {
      ...
      getSkipBanner: function (t, e) {
        return t.oldDirectSettings
          ? (0, s.getAdUsageStorage)(t).getSkipBanner(t, e && e.getUsedIds(t.renderTo))
          : "";
      },
      handleAdAbused: function (t, e, i) {
        var n = this;
        (0, d.shouldSlideUp)(e, i) &&
          t.slideUp(function () {
            var i = e.renderTo,
              o = e.onHide,
        ...
        return (
          ...
          (t.prototype.setVisible = function () {
            var t = this.size,
              ...
              s = 1,
              l = Math.max(
                Math.min(this.size.right, this.winSize.width) - Math.max(this.size.left, 0),
                0
              ),
              p = Math.max(
                Math.min(this.size.bottom, this.winSize.height) - Math.max(this.size.top, 0),
                0
              );
            e
              ? (s *= l / e)
              : (this.size.left < 0 || this.size.right > this.winSize.width) && (s = 0),
              i
                ? (s *= p / i)
                : (this.size.top < 0 || this.size.bottom > this.winSize.height) && (s = 0),
              this.set("visible", s >= this.MIN_VISIBLE_AREA ? 1 : 0),
              (this.isFirstScreen =
                (0 === e && 0 === i && 0 === n && 0 === o && 0 === r && 0 === a) ||
                this.config.top < this.winSize.height);
          }),
          t
        );
      })();
  ...
  function (t, e, i) {
    ...
    var n = i(382),
      o = (function () {
        function t(t) {
          this.experiments = [];
          for (var e = 0; e < t.length; e++) this.experiments.push(new n.Experiment(t[e]));
        }
        return (
          (t.prototype.isCurrentVersion = function (t) {
    ...
    t.exports = function (t) {
      ...
      (this.setData = function (t) {
        (e = t),
          ...
          A.setData(e),
          (v =
            e.common && e.common.reloadTimeout
        ...
        (this.render = function (t, o) {
          ...
          (0, s.logRenderLabel)(t.uniqueId, s.BlockRenderSteps.RtbManagerStart),
            d.horizontalAlign || (d.horizontalAlign = Boolean(t.horizontalAlign));
          var y = Boolean(_.querySelector("#" + t.renderTo));
          y ||
            p.logger.warn(
              new Error("Render to node is null (" + t.pageId + ")(" + t.blockId + ")"),
              "RtbManager::render"
            ),
            (O = null),
            y && e.rtb
              ? ((0, s.setBlockData)(t.uniqueId, {
              ...
              : (x && (x.destructor(), (x = null)), (o || b)());
        }),
        (this.destructor = function () {
          x && x.destructor && x.destructor(),
            A.destructor(),
            (A = null),
            S && ((0, o.removeNodeFromParent)(S), (S = null));
        }),
        (this.slideUp = function (t) {
          ...
          if (x.slideUp) e = x;
            ...
            i.length > 1 &&
              p.logger.warn(
                new Error("DirectManager returned block count of " + i, "RtbManager::slideUp")
              ),
              (e = i[0]);
          }
          e.slideUp &&
  ...
  function (t, e, i) {
    ...
    (e.decode = function (t) {
      ...
      var e,
        i = t.slice(-1);
      return (
        (e = c.trailingSlash && "/" === i ? t.slice(0, -1).split(c.seed)[1] : t.split(c.seed)[1]),
      ...
      (e.encode = function (t) {
        ...
        var e = (function (t) {
          ...
          d =
            ...
            (function (t, e) {
              for (
                var i = c.seed.charCodeAt(0),
                  r = c.seed.charCodeAt(c.seed.length - 1),
                  a = (t * i + r).toString().split("");
                a.length < e;
  ...
  function (t, e, i) {
    ...
    e.serverEncodeEnabled = function (t) {
      return (
        !!Boolean(t) &&
        n.isFunction(t.encodeCSS) &&
        n.isFunction(t.encodeUrl) &&
        n.isFunction(t.decodeUrl) &&
  ...
  function (t, e) {
    t.exports =
      '"use strict";function t(t,e,n){var s=t+"=1";if(-1===document.cookie.indexOf(s)){var a=86400*e*1e3,c=new Date,r=new Date(Number(c)+a).toUTCString();document.cookie=s+"; expires="+r,n()}}function e(t){(new Image).src=t}if(config.rtb){var n=config.rtb.matchUrls;t("pcs3",1,function(){var t,e;t="https://yastatic.net/q/set/s/rsya-tag-users/bundle.js",(e=document.createElement("script")).src=t,document.body.appendChild(e)}),s=.2,Math.random()<s&&t("pcssspb",14,function(){for(var t=0;t<n.length;t++)e(n[t])}),e("https://ysa-static.passport.yandex.ru/static/1/d959d7e39d5067fad30d9c06204866e9/d.png?ex=yes")}var s;';
  },
  function (t, e, i) {
    "use strict";
    e.__esModule = !0;
    ...
    (e.getData = function (t) {
      ...
      (e.canReplaceBlock = function (t) {
        ...
        return (
          !u(e) &&
          (!(!m(e) || ("extensibleMobile" !== t && "oldMotion" !== t)) || !(!f(e) || !d(t)) || d(t))
        );
      }),
      (e.isIgnoredDomain = u),
      (e.isYandexDomain = m),
  ...
  function (t, e, i) {
    ...
    e.IntersectionObserverStrategy = n.combineStrategies(
      o.DocumentVisibilityStrategy,
      r.IntersectionStrategy,
      a.OverlayStrategy
    );
  },
  function (t, e, i) {
  ...
  function (t, e, i) {
    ...
    e["default"] = function (t, e) {
      var i = (function (t, e) {
        ...
        d = p.callouts;
      return (
        (c = r.appendDescription(c, a.prettify(t.text.description))),
        {
          title: t.text.name,
          domain: t.domain || "",
          body: c,
      ...
      return {
        ...
        body: (function (t, e, i) {
          var r = parseInt(t.text["class"]),
            ...
            s = [];
          if (
            (i || "" === t.text.location || s.push(t.text.location),
  ...
  function (t, e, i) {
    ...
    e["default"] = function (t, e) {
      var i = "";
      return (
        t.text.from && t.text.to && (i = t.text.from + " \u2013 " + t.text.to),
        {
          title: i,
          ...
          body: (function (t, e) {
            ...
            return (
              t.price.current &&
                r.push(
                  n["default"]("SMART_FLIGHTS_BODY", e, {
                    price: o.preparePriceText(t.price)
                  })
                ),
              r.push(i + "!"),
    ...
    e["default"] = function (t, e) {
      return {
        ...
        body: (function (t, e) {
          ...
          for (
            var u = [
                ((s = t.text.params), (c = a.PARAMS_DELIMITER), s ? s.split(c) : null),
  ...
  function (t, e, i) {
    ...
    e.__esModule = !0;
    for (var o = i(25), r = i(19), a = [], s = 0; s < 53; s++) a.push(1);
    ...
    (s.prototype = {
      ...
      confirmRtb: function (t, e) {
        this._rtbVisibilityManager ||
          ...
          (e.formatType = (0, a.getFormatByName)(t.name).index),
  ...
  function (t, e, i) {
    ...
    var Bt = w.augment(Object, {
      constructor: function (t, e, i, n, p, c) {
        ...
        (this.dataSource = t),
          (this._renderToNode = (0, v.getContainer)(w.dom.querySelector("#" + i))),
          (this.renderTo = i);
        var S = kt(Ct[b][0]),
          A = S.async,
          O = S.module,
        ...
        switch (b in _.adaptive0418Blocks ? "" : b) {
          case "oldHorizontal":
            ...
            break;
          case "horizontal":
            (0, r.isNewHorizontal)(n)
              ? (0, m.isPosterExperiment)(I, C)
                ? ((O = (S = kt(W)).module), (A = S.async), (E = S.isOld))
                : (0, a.isHorizontal0318)(C) &&
                  ((O = (S = kt(M)).module), (A = S.async), (E = S.isOld))
              : ((O = (S = kt(et)).module), (A = S.async), (E = S.isOld));
            break;
          case "vertical":
          case "flat":
          case "newVertical":
            (0, f.isVertical0318)(b, C) && ((O = (S = kt(B)).module), (A = S.async), (E = S.isOld)),
              (0, l.isNewVertical)(b, C) ||
                ((O = (S = kt(tt)).module), (A = S.async), (E = S.isOld));
            break;
          ...
          case "mailruExtensibleMobile":
            t.isPreviewPage() ||
              (o.isAndroid ? o.androidVersion >= 4.4 : o.isIOS && o.iOSVersion >= 9) ||
        ...
        A ||
          (0, y.setBlockData)(t.getUniqueId(), {
      ...
      getRealBlock: function (t) {
        this._isAsync
          ? this.block.getRealBlock(function (e) {
              return t(e);
            })
          : t(this.block);
      },
      ...
      render: function (t) {
        this._isAsync
          ...
          : (this.isOldBlock
              ? this.block.render()
              : this._renderToNode && k.renderToNode(this._renderToNode, this.block),
            t());
      },
      getMainCont: function () {
  ...
  function (t, e, i) {
    ...
    (e.__esModule = !0),
      (e.getParents = function (t) {
        var e = [];
        if (!t) return e;
        for (var i = t.parentNode; i; ) e.push(i), (i = i.parentNode);
        return e;
      });
  },
  function (t, e, i) {
    ...
    (e.__esModule = !0),
      (e.preventClicks = function (t, e) {
        for (
          var i = ["click", "mousedown", "mouseup", "touchstart", "touchend"],
            n = Date.now(),
            o = function (t) {
    ...
    var n = i(107),
      ...
      p = n(Object, {
        ...
        disconnect: function () {
          ...
          return (
            (e = d((t = this).element)) &&
              (h(e.observers, t), e.observers.length || h(c, e), !c.length && l && m()),
            this
          );
        }
      });
      ...
      l = n(Object, {
        constructor: function (t, e, i) {
          (this._element = t),
            ...
            (this._visibilityChecker = new this._options.VisibilityChecker(
              t,
              r(this._check, this),
              {
        ...
        _cancelConfirmSchedule: function () {
          null !== this._confirmTimeoutId &&
            (clearTimeout(this._confirmTimeoutId), (this._confirmTimeoutId = null));
        },
        confirm: function () {
    ...
    t.exports = function (t) {
      ...
      return (
        e.push(
          ...
          new t.utils.Color(t.settings.urlColor || "#0000CC").setAlpha(0.4),
          " !important;border-bottom-width:",
          t.settings.linksUnderline ? 1 : 0,
          "px !important;border-bottom-style:",
          t.utils.browser.isSafari ? "inset" : "solid",
          " !important}.",
          t.id,
          " .ga679cbc9:hover,.",
          t.id,
          " .ga679cbc9:hover b{color:",
          t.settings.hoverColor || "#0088CC",
          " !important;border-bottom-color:",
          new t.utils.Color(t.settings.hoverColor || "#0088CC").setAlpha(0.4),
          " !important}.",
          t.id,
    ...
    t.exports = function (t) {
      ...
      return (
        e.push(
          ...
          " !important}.",
          t.id,
          " .caab3995f em{font-style:normal !important}.",
          t.id,
          ...
          new t.utils.Color(t.settings.textColor || "#0000").setAlpha(0.4),
          " !important;border-bottom-width:",
          t.settings.linksUnderline ? 1 : 0,
          "px !important;border-bottom-style:",
          t.utils.browser.isSafari ? "inset" : "solid",
        ...
        return (
          ...
          (e.prototype.onInit = function () {
            ...
            this.initState(),
              ...
              (this.renderedOptions = (((e = {})[s.small] = []), (e[s.large] = []), e)),
          ...
          (e.prototype.onMount = function () {
            ...
            this.abuseElement && this.containerElement && this.state.wasOpenedFeedback) &&
              (this.setOrientation(), this.selectLayout());
          }),
          ...
          (e.prototype.tryLayouts = function (t) {
            for (var e = 0; e < t.length; e++) {
              var i = t[e],
                ...
                o = n && n.optionSize;
              if (
                (0 === e && ((o = i.optionSize), this.abuse.addClass(this.b_(i.className))),
          ...
          (e.prototype.isLayoutOverflows = function (t) {
            return (
              u.hasScrollInParentElement(this.abuseElement) ||
          ...
          (e.prototype._render = function () {
            return this.state.wasOpenedFeedback
              ? l.create(
                  "yatag",
                  {
                    resourceId: "abuse",
                  ...
                  l.create(
                    ...
                    l.create(
                      ...
                      this.renderOptions(s.small),
                      this.renderOptions(s.large),
    ...
    t.exports = function (t) {
      ...
      return (
        e.push(
          ...
          " .b2637ef68 .a1e92531,#",
          t.id,
          " .b2637ef68 .o6aba2690{display:none !important}#",
          t.id,
    ...
    t.exports = function (t) {
      ...
      return (
        e.push(
          ".",
          t.id,
          " .u3c7175d7{display:inline !important}.",
          t.id,
          " .c40e0f31f{display:none !important}.",
          t.id,
          ...
          t.id,
          " .b548a34fc{top:-1px !important;color:",
          new t.utils.Color(t.settings.bgColor || t.settings.siteBgColor || "#FFFFFF")
            .readable()
            .setAlpha(0.3),
          ...
          t.id,
          " .af5d6d6f2{vertical-align:top !important}.",
          t.id,
          ...
          " !important;background-color:",
          t.utils.warning.getBgColor(t.settings.bgColor || t.settings.siteBgColor || "#FFFFFF"),
          " !important}.",
          t.id,
          " .o518765fc{font-size:.9em !important}.",
          t.id,
    ...
    t.exports = function (t) {
      ...
      return (
        e.push(
          ".",
          t.id,
          " .wa6f3481{display:inline !important}.",
          t.id,
    ...
    t.exports = function (t) {
      ...
      return (
        e.push(
          ...
          " !important;font-weight:400 !important;zoom:0 !important}.",
          t.id,
          " .n678c01f4,.",
          t.id,
          " .k809e8c22{vertical-align:middle !important}.",
          t.id,
          " .d2d302cbf:hover{background:",
          t.settings.hoverColor || "#0088CC",
          " !important}.",
          t.id,
          " .d2d302cbf:hover .k809e8c22{color:",
          ...
          " .l77b92e60 .k809e8c22,.",
          t.id,
          " .l77b92e60:hover .k809e8c22{padding:.5em 1.2em !important}.",
          t.id,
          " .ia25f217b,.",
          t.id,
          ...
          t.id,
          " .q62938b93{border:2px solid !important;border-color:",
          new t.utils.Color(t.settings.bgColor || "#FFF").readable(),
          " !important;background:",
          t.settings.bgColor || "#FFF",
          " !important}.",
          t.id,
          " .q62938b93 .k809e8c22{color:",
          new t.utils.Color(t.settings.bgColor || "#FFF").readable(),
          " !important;font-size:1.15em !important;font-weight:700 !important;vertical-align:top !important}.",
          t.id,
          " .q62938b93 .n678c01f4{border-radius:0 !important}.",
          t.id,
          " .q62938b93:hover{background:",
          t.settings.hoverColor || "#0088CC",
          " !important}.",
          t.id,
          " .q62938b93:hover .k809e8c22{color:",
          new t.utils.Color(t.settings.hoverColor || "#0088CC").readable(),
          " !important}.",
          t.id,
          " .f34b9742a .k809e8c22,.",
          t.id,
          " .f34b9742a:hover .k809e8c22{color:",
          t.textColor || "#fff",
          " !important}.",
          t.id,
          " .p73dd045f,.",
    ...
    t.exports = function (t) {
      ...
      return (
        e.push(
          ...
          new t.utils.Color(t.settings.textColor || "#000").setAlpha(0.55),
          " !important}.",
          t.id,
    ...
    t.exports = function (t) {
      ...
      return (
        e.push(
          ".",
          t.id,
          " .x100e4e5f{display:inline !important}.",
          t.id,
    ...
    t.exports = function (t) {
      ...
      return (
        e.push(
          ...
          t.id,
          " img.af39f9b85{width:16px !important;height:16px !important}"
        ),
        e.join("")
      );
    };
    ...
    t.exports = function (t) {
      ...
      return (
        e.push(
          ".",
          t.id,
          " .uaca5b656{max-width:100% !important}.",
          t.id,
          " .w828f8880{max-width:100% !important;box-sizing:border-box !important;white-space:nowrap !important}.",
          t.id,
          " .kea8eb6bb{display:inline-block !important}.",
          t.id,
          " .b83e558b7 .n678c01f4,.",
          t.id,
          " .b1da1c5d1 .kea8eb6bb{display:none !important}.",
          t.id,
          " .h8d3853ed .w828f8880 .k809e8c22{padding-left:.6em !important}.",
          t.id,
          " .leec452ff .k809e8c22{font-size:.9em !important}.",
          t.id,
          " .a9af6eefc .k809e8c22{font-size:.8em !important}.",
          t.id,
          " .g1dd31cfd .k809e8c22{font-size:.7em !important}.",
          t.id,
    ...
    t.exports = function (t) {
      ...
      return (
        e.push(
          ...
          t.id,
          " .b862ab121{text-align:center !important}.",
          t.id,
      ...
      o =
        ...
        i(7)["default"],
        {
          mobileApp: function (t) {
            var e = [];
            e.push(
              '<yatag class="yap-mobile-app ',
              t.plainLink ? "yap-mobile-app_inline" : "",
              '">'
            );
            var i = t.ad.addInfo.price
              ? "&nbsp;&ndash; " + t.ad.addInfo.price + "&nbsp;" + t.ad.addInfo.priceCurrencySymbol
              : null;
            return (
              e.push(""),
              t.plainLink
                ? e.push(
                    '<a class="yap-mobile-app__link" href="',
                    t.ad.addInfo.callToActionUrl,
                    '" target="_blank">',
                    t.ad.addInfo.callToAction + (i || ""),
                    "</a>"
                  )
                : e.push(
                    '<yatag class="yap-mobile-app__button">',
                    o.buttonMobile({
          ...
          mobileApp__rating: function (t) {
            ...
            e.push(
              '<yatag class="yap-mobile-app__rating ',
              i,
              '" title="',
              "\u0420\u0435\u0439\u0442\u0438\u043d\u0433 " + t.ad.addInfo.rating + " / 5",
              '"><yatag class="yap-mobile-app__rating-stars"><yatag class="yap-mobile-app__rating-stars-scale">'
            );
            for (var a = 0; a < 5; a++)
              e.push(
                '<yatag class="yap-mobile-app__rating-star">',
                o.mobileApp__star({}),
                "</yatag>"
              );
            e.push(
            ...
            return (
              ...
              t.ad.addInfo.reviewCount &&
                e.push('<yatag class="yap-mobile-app__rating-votes">', r, "</yatag>"),
              e.push("</yatag>"),
              e.join("")
            );
          },
    ...
    t.exports = function (t) {
      ...
      return (
        e.push(
          ...
          t.settings.titleColor || "#0000CC",
          " !important;border-bottom-color:",
          new t.utils.Color(t.settings.titleColor || "#0000CC").setAlpha(0.4),
          " !important;border-bottom-width:",
          t.settings.linksUnderline ? 1 : 0,
          "px !important;border-bottom-style:",
          t.utils.browser.isSafari ? "inset" : "solid",
    ...
    t.exports = function (t) {
      ...
      return (
        e.push(
          ...
          t.id,
          " .a43b5611e{text-align:center !important}.",
          t.id,
          " .j86b874c3{text-decoration:underline !important;white-space:pre !important}.",
          t.id,
          " .j86b874c3:hover{color:",
          new t.utils.Color(t.settings.bgColor || t.settings.siteBgColor || "#FFFFFF")
            .readable()
            .setAlpha(0.5),
          " !important}.",
          t.id,
          " .f6e8bd17{display:table !important}.",
          t.id,
          ...
          t.id,
          " .rc1d03b70.g310913d1{font-size:0 !important}.",
          t.id,
          ...
          t.id,
          " .g92c36e0f .p793eddf6{z-index:0 !important}.",
          t.id,
          ...
          t.id,
          " .e2d62993 .s1aa15592:hover{color:",
          t.settings.hoverColor || "#0088CC",
          " !important}.",
          t.id,
          ...
          t.id,
          " .s8fc70475{width:100% !important;border:none !important}.",
          t.id,
    ...
    t.exports = function (t) {
      ...
      return (
        e.push(
          ...
          t.id,
          " .s3d877ae1{z-index:3 !important}.",
          t.id,
          " .v5a26352d .i4be7aec6{position:relative !important}.",
          t.id,
          " .qf98d4624{display:inline-block !important}.",
          t.id,
    ...
    var r = i(0),
      ...
      s = (function (t) {
        function e() {
          var e = (null !== t && t.apply(this, arguments)) || this;
          return (
            (e.onChangeBlockState = function (t, i) {
              (null !== i && i.status === t.status) ||
                (e.props.callback(t.status) && e.context.unChangeState(e.onChangeBlockState));
            }),
            e
          );
        }
  ...
  function (t, e, i) {
    ...
    (e.__esModule = !0),
      (e.every = function (t, e) {
        for (var i = 0; i < t.length; i++) if (!e(t[i], i, t)) return !1;
        return !0;
      });
  },
  function (t, e, i) {
        ...
        return (
          ...
          (e.prototype._render = function (t, e, i) {
            ...
            return r.create(
              "yatag",
              {
                ...
                class: t(
                  t(),
                  "_border-type_" + o.borderType,
                  "_title-font_" + o.titleFontSize,
                  e["class"],
                  this.mod
                ),
                style: {
          ...
          (e.prototype.renderAd = function (t, e, i) {
            return r.create(
              ...
              this.renderImage(t, e, i),
              this.renderContent(t, e, i)
            );
          }),
    ...
    t.exports = function (t) {
      ...
      return (
        e.push(
          ".",
          t.id,
          " .w7be6531a{max-width:460px !important}.",
          t.id,
          ...
          t.id,
          " .o61aaf7a0{margin-top:-5px !important}.",
          t.id,
          ...
          t.id,
          " .ic0a09791{margin:-10px -20px 0 !important}.",
          t.id,
          " .v489ed35a{margin:10px 0 0 -30px !important}.",
          t.id,
          ...
          t.id,
          " .k560dfa10 .a43b5611e{padding:0 30px 0 10px !important}.",
          t.id,
          " .k560dfa10.f6e8bd17{background-color:",
          t.warningBgColor,
          " !important;border-width:0 !important}.",
          t.id,
          ...
          t.id,
          " .q28e45eb3 .c33575590{font-size:20px !important}.",
          t.id,
          " .d8c523cb0 .a6e70116a{font-size:12px !important}.",
          t.id,
        ...
        return (
          ...
          (e.prototype._render = function (t, e, i) {
            var n = e.adv,
              ...
              g = n.image;
            return (
              g && (this.picture = g.getFitting(h.width, h.height, 0)),
    ...
    t.exports = function (t) {
      ...
      return (
        e.push(
          ".",
          t.id,
          " .b9dbb7f91{left:15px !important;height:18px !important}.",
          t.id,
          " .b9dbb7f91 .caab3995f{line-height:18px !important}.",
          t.id,
          " .p291e1855{padding:5px !important}.",
          t.id,
          " .s4162e33f{position:absolute !important;bottom:0 !important}.",
          t.id,
          " .s4162e33f .e80e7f7e9{opacity:.47 !important}.",
          t.id,
          ...
          t.id,
          " .p1240f99a{font-size:18px !important}.",
          t.id,
          " .a23e7493d{margin-top:7px !important;font-size:.78em !important}.",
          t.id,
          " .a6e70116a{margin-top:7px !important}.",
          t.id,
          " .k560dfa10{box-sizing:border-box !important;width:100% !important}.",
          t.id,
          " .q28e45eb3 .p1240f99a{font-size:15px !important}.",
          t.id,
          " .d8c523cb0{font-size:13px !important}.",
          t.id,
          " .h6921a31{font-size:12px !important}.",
          t.id,
          " .o4233e436{font-size:11px !important}.",
          t.id,
          " .j119c62b7 .a6e70116a{overflow:hidden !important;text-overflow:ellipsis !important;white-space:nowrap !important}.",
          t.id,
          " .v750a40b4 .a6e70116a{white-space:normal !important}.",
          t.id,
    ...
    t.exports = function (t) {
      ...
      return (
        e.push(
          ".",
          t.id,
          " .faacc0e20{position:relative !important}.",
          t.id,
          " .o5ee038eb{display:none !important}"
        ),
        e.join("")
      );
    };
      ...
      x = (function (t) {
        ...
        return (
          ...
          (e.prototype.getAdvSpacing = function (t, e) {
            return (
              (t === b.COLLAPSE ? -1 : this.settings.advSpacing || 5) - 2 * (t === b.BLOCK ? e : 0)
            );
          }),
          (e.prototype.beforeRender = function (e) {
            var i = this;
            t.prototype.beforeRender.call(this, e),
              ...
              (this.sizeMeter = g.createSizeMeter(this.props.renderToNode, this.settings, function (
                t,
                e
              ) {
          ...
          (e.prototype.createAdvList = function () {
            ...
            return (
              this.getDataSource().doSortByImages() &&
                e.sort(function (t, e) {
          ...
          (e.prototype.cutBlock = function (t, e, i) {
            return _.cutBlock({
              ...
              grows:
                "horizontal" === this.settings.measurer
                  ? p.map(t, function () {
                      return 1;
                    })
                  : p.map(t, function (t) {
  ...
  function (t, e, i) {
    ...
    var m = function (t) {
      ...
      f = (function () {
        ...
        return (
          (t.prototype.doOnReady = function (t) {
          ...
          (t.prototype.getTheme = function () {
            ...
            var t = this.settings,
              ...
              h = new s.Color(t.bgColor || t.siteBgColor || "#f5f5f5").setAlpha(
  ...
  function (t, e, i) {
    ...
    (e.cutBlock = function (t) {
      var e = t.advList,
        ...
        g = Math.floor(
          Math.max(
            ...
            Math.min(
              h / s,
              a ? n.getSectionLimit(d, m + l, p + l) : n.getSectionLimit(d, f + l, c + l)
            )
          )
        ),
      ...
      (e.calcGrid = function (t, e) {
        for (
          var i = Math.ceil(Math.min(Math.sqrt(t), e)), n = t % i, o = (t - n) / i, r = [], a = 0;
          a < i;
          a++
        )
          r.push(o + (a < n ? 1 : 0));
  ...
  function (t, e) {
    t.exports =
      '<svg height="1em" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg"><path d="M12.135 14.167l-1.23-5.242L15 5.398l-5.393-.462L7.5 0 5.393 4.936 0 5.398l4.088 3.527-1.223 5.242L7.5 11.386z"/></svg>';
  },
  function (t, e, i) {
    "use strict";
    var n,
  ...
  function (t, e) {
    t.exports =
      '<svg height="1em" viewBox="0 0 72.5 100" xmlns="http://www.w3.org/2000/svg"><path d="M5 0h40a27.5 27.5 0 0 1 0 55H15v6h38v10H15v29H5V71H0V61h5v-6H0V45h5zm10 10h30a17.5 17.5 0 0 1 0 35H15z" fill-rule="evenodd"/></svg>';
  },
  function (t, e, i) {
    "use strict";
    var n,
    ...
    var m = (function () {
      ...
      return (
        ...
        (t.prototype.getExcessResources = function (t, e, i, n) {
          for (
            var o = this.getLength(t) - this.getTotalLength(n),
              r = {},
              a = 0,
              c = s.selectFittingSegments(n, e - o, i - o);
            a < c.length;
            a++
          ) {
            var d = c[a].id;
          ...
          var u = {};
          return (
            l.traverseBreadth(n, function (t) {
  ...
  function (t, e, i) {
    ...
    e.selectFittingSegments = function (t, e, i) {
      ...
      return (
        r.traverseBreadth(s, function (t) {
          for (
            var r = t.node, s = t.path, p = r.segments, c = r.children, d = r.weight, u = 0, m = p;
            u < m.length;
            u++
          ) {
            var f = m[u],
          ...
          return (
            0 === g && (g = n.compareArrays(a(s.length), a(l.length))),
            g > 0 && (l = s),
            s.length >= e
              ? []
              : o.map(c, function (t) {
    ...
    t.exports = function (t) {
      ...
      return (
        e.push(
          ...
          t.id,
          " .yap-adtune-icon__image svg{display:block !important}.",
          t.id,
          ...
          t.id,
          " .yap-adtune-icon_touch_true{visibility:visible !important}.",
          t.id,
          ...
          t.id,
          " .yap-adtune-icon_round{padding:5px !important}.",
          t.id,
          ...
          " !important}.",
          t.id,
          " .yap-adtune-icon_round-square{padding:4px !important}.",
          t.id,
          ...
          t.id,
          " .yap-adtune-message__text{margin-left:10px !important}.",
          t.id,
          " .yap-adtune-message__icon svg{fill:#000 !important}.",
          t.id,
          " .yap-adtune-message_big{font-size:15px !important}.",
          t.id,
          ...
          t.id,
          " .yap-abuse-message__logo{font-weight:700 !important}.",
          t.id,
          " .yap-abuse-message__logo_small{display:none !important;font-weight:700 !important}.",
          t.id,
          " .yap-abuse-message__logo-wrapper,.",
          t.id,
    ...
    t.exports = function (t) {
      ...
      return (
        e.push(
          ".",
          t.id,
          " .yap-layout__warning{z-index:100 !important}.",
          t.id,
          ...
          " !important;font-family:verdana !important;background:transparent !important;height:17px !important}.",
          t.id,
          " .yap-warning__text{text-align:center !important}.",
          t.id,
          " .yap-warning__link{text-decoration:underline !important;white-space:pre !important}.",
          t.id,
          " .yap-warning__link:hover{color:",
          new t.utils.Color(t.settings.bgColor || t.settings.siteBgColor || "#FFFFFF")
            .readable()
            .setAlpha(0.5),
          " !important}.",
          t.id,
          " .yap-warning_medical{display:table !important}.",
          t.id,
          ...
          t.id,
          " .yap-layout .yap-layout__warning-button-text:hover{color:",
          t.settings.hoverColor || "#0088CC",
          " !important}.",
          t.id,
    ...
    t.exports = function (t) {
      ...
      return (
        e.push(
          ...
          t.id,
          " .yap-picture-stub__column{display:inline-block !important}.",
          t.id,
  ...
  function (t, e, i) {
    ...
    e.isNewPoster = function (t) {
      var e = {
        ...
        i = o.some(
          [/smi2\.ru/i, /drive\.ru/i, /drive2\.ru/i, /mail\.yandex\.ru/i, /politfox\.ru/i],
          function (e) {
            return e.test(t);
          }
        );
      return (
        !!o.some([/^mail\.rambler\.ru/i, /^tv\.yandex\.ru/i], function (e) {
          return e.test(t);
        }) ||
        (!i && !n.isHostIgnored(e))
      );
      ...
      (this.getSettings = function () {
        ...
        (this.getViewNotices = function () {
          var t = [],
            e = this.getSettings();
          return (
            e.viewNotices && e.viewNotices.length && (t = t.concat(e.viewNotices)),
            "string" == typeof e.viewNotice && "" !== e.viewNotice && t.push(e.viewNotice),
            (t = (0, r.map)(t, function (t) {
        ...
        i.clickMacro &&
          (0, a.isString)(i.clickMacro) &&
          !e.clickMacro &&
          ((0, n["default"])(window) || this.isSSP()) &&
        ...
        (this._visibilityTime = (0, c.calcVisibilityTime)(this.getSettings())),
  ...
  function (t, e, i) {
    ...
    function L(t) {
      (this._isContainingSafeFrame = !1),
        ...
        (this._nonce = t.nonce),
        (this._mainContId =
          "ya_partner_" + this.blockId + (t.pageNumber ? "-" + t.pageNumber : "")),
    ...
    (L.prototype = {
      render: function (t) {
        ...
        (this._size = this.dataSource.getSize()),
          ...
          (this._container = (0, s.getContainer)(t)),
          "modernAdaptive" === e.name && (this._horizontalAlign = !0),
          e.displayDelayed
            ? ((0, n.stopLoggingTime)(this.dataSource.getUniqueId()),
      ...
      destructor: function () {
        this._clearComponents(),
          this._styleElement && (y.dom.remove(this._styleElement), (this._styleElement = null)),
          ...
          this._container && (0, _.clearHTML)(this._container);
      },
      ...
      _createTemplate: function () {
        ...
        this._createWrapper(
          !t || (this._isAlternativeCode && !(0, r.isTurboPage)(window)) ? v.RtbIframe.TAG : ""
        );
      },
      _renderAd: function (t) {
        var e = this.dataSource.getHtml();
        e && this._isAlternativeCode && !(0, r.isTurboPage)(window)
          ? this._renderAlternativeCode(t)
          : e
          ? this._renderSafeframe(t)
          : this._renderFromUrl(t);
      },
      ...
      _getSafeframeBasePath: function () {
        ...
        return (
          a.urlCodeVersions.media && (t.mcodever = a.urlCodeVersions.media),
          new w({
      ...
      isInViewport: function () {
        return (
          !!y.dom.querySelector("#" + this._mainContId) &&
          y.dom.isInViewport(this._container, v.REFRESH_VIEWPORT_VISIBLE_PART)
        );
      },
      _isInPage: function () {
  ...
  function (t, e, i) {
    ...
    (I.prototype = {
      render: function (t, e, i, n) {
        (0, m.logRenderLabel)(t.uniqueId, m.BlockRenderSteps.DirectRender),
          n && (this._refresh = n);
      ...
      _loadData: function (t, e, i, n, c) {
        if (e.data)
          return (0, a.saveBundleType)(e.data), void this._parseData(e.data, t, e, i, n, c);
        if (!t.dataCanReload() && "stripe" !== e.product)
          return (0, a.saveBundleType)(e.bundle), void this._render(t, e, i, n, c);
        ...
        (0, m.setBlockData)(e.uniqueId, {
          ...
          _.loadDirect(
            ...
            function (o) {
              (0, m.logRenderLabel)(e.uniqueId, m.BlockRenderSteps.LoadDone),
                u.logger.log({
                  isInQueue: e.isInQueue,
                  testtag: g
                }),
                (0, a.saveBundleType)(o),
                (d._refresh = !1),
      ...
      _parseData: function (t, e, i, n, o, r) {
        "stripe" === i.product
          ...
          : (e.setData(t),
            n ||
              ((n = t.settings && t.settings[i.blockImpId] ? t.settings[i.blockImpId] : {}),
        ...
        if ((i.set("ad_no", (0, o.getAdUsageStorage)(t).getCapturedCount()), e)) {
          ...
          if (r) {
            ...
            var a =
              -1 !==
              x.inArray(
                [g.BlockTypes.HORIZONTAL, g.BlockTypes.VERTICAL, g.BlockTypes.GRID],
                r.type
              );
            if (!r.fixed && a) {
      ...
      _handleAdAbused: function (t, e, i) {
        ...
        if ((0, c.shouldSlideUp)(e, i)) {
          ...
          t.slideUp(o, function () {
            var i = e.renderTo,
              o = e.onHide;
            0 === t.getBlocks().length &&
              x.forOwn(n._managers, function (e, i) {
      ...
      (n = []),
        i
          ...
          .then(
            function () {
              o = i(668);
              for (var t = 0, e = n.length; t < e; t++) n[t].success(o);
              (r = !1), (n = null);
            }.bind(null, i)
          )
          .catch(function () {
            for (var t = 0, e = n.length; t < e; t++) n[t].error.apply(this, arguments);
            (r = !0), (n = null);
          });
    }
    (t.exports = function (t, e) {
